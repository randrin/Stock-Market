...
<%@include file="Header.jsp"%>
	<div class="container col-md-8 col-md-offset-2" style="padding-top: 50px;">
		<div class="panel panel-primary">
			<div class="panel-heading"><h4><strong><i class="fa fa-check-circle fa-lg"></i> Confirmation Editer Produits</strong></h4></div>
			<div class="panel-body">
			<h3 style="color: red;"><strong>Vous avez correctement modifier ce produit</strong></h3><br>
					<!-- ID Produit -->
					...
					<br>
					<a href="produitsStock.php" class="btn btn-primary"><strong><i class="fa fa-shopping-cart fa-lg"></i> Produits Stock</strong></a>
			</div>
		</div>
	</div>
</body>
